...
#ifndef OPENOCL_UI_SCROLLPANE_H
#define OPENOCL_UI_SCROLLPANE_H
...
class ScrollPane : public Pane, public LayoutManager
{
public:
	ScrollPane( Component& aComponent, unsigned int width = 2000, unsigned int height = 2560, bool buffered = false );
	virtual ~ScrollPane();
