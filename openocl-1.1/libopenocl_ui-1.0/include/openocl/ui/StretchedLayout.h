...
#ifndef OPENOCL_UI_STRETCHEDLAYOUT_H
#define OPENOCL_UI_STRETCHEDLAYOUT_H
...
class StretchedLayout : public openocl::base::Object, public LayoutManager
{
public:
  StretchedLayout();
  StretchedLayout( flags layoutHints );
  virtual ~StretchedLayout();
